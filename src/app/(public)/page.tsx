...
import SpotlightRevealPhoto from "@/components/spotlight-reveal-photo";
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10 py-12">
          ...
          <div className="lg:col-span-6 space-y-8 pr-0 lg:pr-8">
            <ScrollReveal direction="right">
              <span className="text-[10px] font-bold tracking-[0.25em] text-[#8B5A2B] uppercase border border-[#8B5A2B]/20 px-4 py-2 rounded-none bg-white/40 backdrop-blur-sm">
                Venerable Heritage · Since 2006
              </span>
            </ScrollReveal>
            
            <ScrollReveal direction="right" delay={0.1}>
              <AnimatedHeading text={heroData.title} className="text-5xl sm:text-6xl md:text-7xl font-normal font-serif text-[#6B1D3A] leading-[0.95] tracking-tight italic" />
            </ScrollReveal>

            {/* Double-line saffron/maroon block layout */}
            <div className="border-y border-[#8B5A2B]/15 py-6">
              <ScrollReveal direction="right" delay={0.2}>
                <p className="text-base text-[#1C1C1E] leading-relaxed max-w-xl">
                  {heroData.subtext}
                </p>
              </ScrollReveal>
            </div>
            ...
            <ScrollReveal direction="right" delay={0.3}>
              <div className="flex flex-wrap gap-4 pt-2">
                <Link
                  href="/enrollment"
                  className="px-8 py-3.5 bg-[#6B1D3A] text-white text-[11px] font-bold tracking-[0.2em] uppercase rounded-none transition-all duration-300 flex items-center space-x-2 border border-[#6B1D3A] btn-wipe btn-wipe-maroon"
                >
                ...
                <Link
                  href="/#about"
                  className="px-8 py-3.5 bg-white/60 border border-[#E6DDD0] hover:text-[#1C1C1E] text-[#1C1C1E] text-[11px] font-bold tracking-[0.2em] uppercase rounded-none transition-all duration-300 btn-wipe"
                >
                  Learn History
                </Link>
              </div>
          ...
          {/* Hero Visual Mockup Image (Sharp grid framed layout with Lerped Spotlight Reveal) */}
          <div className="lg:col-span-6 pl-0 lg:pl-8 flex justify-center">
            <ScrollReveal direction="left" delay={0.2}>
              <div className="relative w-full aspect-[4/3] max-w-[540px] rounded-none overflow-hidden border border-[#E6DDD0] p-4 bg-white/40 shadow-none">
                <SpotlightRevealPhoto imageUrl={heroData.imageUrl} alt="Dhamma School Cover" />
              </div>
            </ScrollReveal>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <ScrollReveal delay={0.1}>
              <p className="text-base text-[#1C1C1E] leading-relaxed first-letter:text-5xl first-letter:font-serif first-letter:font-normal first-letter:text-[#6B1D3A] first-letter:float-left first-letter:mr-3 first-letter:mt-1">
                {aboutData.historyText}
              </p>
            </ScrollReveal>

            {/* Saturday Timeline */}
            <div className="pt-8 border-t border-[#E6DDD0]">
              <SaturdayTimeline />
            </div>
          </div>

          {/* Right Block: Bento Stat Cards Grid (Sharp layout) */}
          <div className="lg:col-span-5 grid grid-cols-2 gap-5 lg:sticky lg:top-36">
            
            {/* Stat Card 1 */}
            <ScrollReveal direction="up" delay={0.1}>
              <div className="bg-[#F0E6D6]/40 border border-[#E6DDD0] p-8 rounded-none text-center hover:bg-[#F0E6D6]/90 transition-all duration-300">
                <span className="block text-5xl font-normal font-serif text-[#6B1D3A] italic">20</span>
            ...
            <ScrollReveal direction="up" delay={0.15}>
              <div className="bg-[#F0E6D6]/40 border border-[#E6DDD0] p-8 rounded-none text-center hover:bg-[#F0E6D6]/90 transition-all duration-300">
                <span className="block text-5xl font-normal font-serif text-[#6B1D3A] italic">100+</span>
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <div className="bg-[#F0E6D6]/40 border border-[#E6DDD0] p-8 rounded-none text-center hover:bg-[#F0E6D6]/90 transition-all duration-300">
                <span className="block text-5xl font-normal font-serif text-[#6B1D3A] italic">10</span>
                <span className="block text-[10px] font-bold text-[#8B5A2B] uppercase tracking-[0.2em] mt-3">Teachers</span>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" delay={0.25}>
              <div className="bg-[#F0E6D6]/40 border border-[#E6DDD0] p-8 rounded-none text-center hover:bg-[#F0E6D6]/90 transition-all duration-300">
                <span className="block text-5xl font-normal font-serif text-[#6B1D3A] italic">2,000+</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-36 border-b border-[#E6DDD0]">
        <ScrollReveal>
          <div className="text-center max-w-xl mx-auto mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-normal font-serif text-[#6B1D3A] mt-2 italic">Captured Moments</h2>
            <p className="text-xs text-[#1C1C1E]/80 mt-3 leading-relaxed">
              ...
              <div className="space-y-5">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#1C1C1E] mt-1">Susilodaya Viharaya, Temple Road, Colombo, Sri Lanka</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#1C1C1E] mt-1">+94 11 234 5678</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
