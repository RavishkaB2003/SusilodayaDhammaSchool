...
export default function Footer() {
  return (
    <footer className="bg-[#2C1B18] text-[#FFF8F0] border-t border-[#8B5A2B]/20 pt-20 pb-12 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-16">
          ...
          <div className="space-y-5 col-span-1 md:col-span-2">
            <span className="font-serif text-3xl font-normal tracking-tight text-[#E89E5F] italic">Susilodaya</span>
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-xs font-bold tracking-[0.25em] text-[#E89E5F] uppercase mb-5">Quick Links</h4>
          ...
          {/* Contact details */}
          <div>
            <h4 className="text-xs font-bold tracking-[0.25em] text-[#E89E5F] uppercase mb-5">Contact Info</h4>
            <ul className="space-y-4 text-xs text-[#F0E6D6]/70">
              <li className="flex items-start space-x-3">
                <svg className="w-4.5 h-4.5 text-[#E89E5F] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
              ...
              <li className="flex items-center space-x-3">
                <svg className="w-4.5 h-4.5 text-[#E89E5F] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        ...
        <div className="border-t border-[#8B5A2B]/10 pt-8 mt-8 flex flex-col md:flex-row items-center justify-between text-[11px] text-[#F0E6D6]/40 tracking-wider">
          <p>© {new Date().getFullYear()} Susilodaya Dhamma School. All rights reserved.</p>
          <div className="flex space-x-4 mt-4 md:mt-0 font-serif italic text-xs text-[#E89E5F]/60">
